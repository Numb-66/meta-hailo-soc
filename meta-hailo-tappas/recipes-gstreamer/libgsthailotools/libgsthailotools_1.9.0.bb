...
<<<<<<<< HEAD:meta-hailo-tappas/recipes-gstreamer/libgsthailotools/libgsthailotools_1.8.1.bb
...
>>>>>>>> upstream/1.9.0:meta-hailo-tappas/recipes-gstreamer/libgsthailotools/libgsthailotools_1.9.0.bb
...
DEPENDS += "glib-2.0-native glib-2.0 gstreamer1.0 gstreamer1.0-plugins-base rapidjson cppzmq json-schema-validator"
EXTRA_OEMESON += " \

...
<<<<<<<< HEAD:meta-hailo-tappas/recipes-native-apps/reference-camera-api/reference-camera-api_1.8.1.bb
...
>>>>>>>> upstream/1.9.0:meta-hailo-tappas/recipes-native-apps/reference-camera-api/reference-camera-api_1.9.0.bb
LICENSE = "LGPLv2.1"

...
S3_URI = "https://hailo-hailort.s3.eu-west-2.amazonaws.com/Hailo15/1.6.2-dev0/dsp-fw"
FW = "dsp-fw.elf"

SRC_URI = "${S3_URI}/${FW};name=fw \
           ${S3_URI}/LICENSE;name=lic"

SRC_URI[fw.sha256sum] = "cfb69d477972cffa46d31142f84f2f9181272b397aa5f434af4da8cf6eb7857c"
